...
Report generated by Softrate Tech Park Pvt. Ltd.`;
  ...
  function updateDbStatusBanner(usingFallback) {
    if (usingFallback) {
      ...
      dbStatusText.textContent = "Fallback File DB Active";
      dbStatusBanner.title = "MongoDB could not be contacted. Saving computations locally to JSON file.";
    } else {
      dbStatusBanner.className = "db-status-banner online";
      dbStatusText.textContent = "MongoDB Connected";
      dbStatusBanner.title = "MongoDB server online. Calculations synchronized.";
    }
  }
