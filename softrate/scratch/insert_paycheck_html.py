            ...
            <div class="paycheck-section-block">
              <div class="paycheck-form-group">
                ...
                <select id="paycheckState">
                  ...
                  <!-- Add other states as needed, default CA -->
                </select>
              </div>
            </div>
...
def main():
    ...
    # 1. Insert CSS link
    if '<link rel="stylesheet" href="/static/css/paycheck.css">' not in content:
        content = content.replace('<link rel="stylesheet" href="/static/css/financial_report.css">', 
                                  '<link rel="stylesheet" href="/static/css/financial_report.css">\n  <link rel="stylesheet" href="/static/css/paycheck.css">')

    # 2. Insert JS script
    if '<script src="/static/js/paycheck.js"></script>' not in content:
        content = content.replace('<script src="/static/js/financial_report.js"></script>',
                                  '<script src="/static/js/financial_report.js"></script>\n  <script src="/static/js/paycheck.js"></script>')

    # 3. Insert Paycheck Section before Gratuity Section
    if 'id="paycheck-section"' not in content:
        content = content.replace('<!-- Section: Gratuity Calculator -->', HTML_CONTENT + '\n      <!-- Section: Gratuity Calculator -->')
